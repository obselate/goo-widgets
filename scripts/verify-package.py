...
with ZipFile(package) as archive:
    required = {"lib/net10.0/Goo.Widgets.dll", "lib/net10.0/Goo.Widgets.xml", "README.md"}
    ...
    if metadata.findtext("n:license", namespaces=ns) != "MIT":
...
print(f"Verified {package.name}: assembly, XML documentation, README, MIT, Goo 0.5.1.")
