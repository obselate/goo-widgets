...
def validate_package(package_id, directory, license_expression, extra_files=()):
    ...
    with ZipFile(package) as archive:
        ...
        if package_id == "Goo.Widgets" and "Markdig" in dependencies:
            raise SystemExit("Markdig must remain optional.")
...
validate_package("Goo.Widgets", "package", "MIT AND Apache-2.0",
                 ("licenses/material-symbols/LICENSE", "licenses/material-symbols/README.md"))
if "--markdown" in sys.argv[1:]:
    validate_package("Goo.Widgets.Markdown", "markdown-package", "MIT")
