...
internal class TreeViewExample : Cell {
  ...
  private func Expand(id string, value bool) {
    ...
    for current in expanded { if current != id { next.Add(current) } }
  ...
  private func Check(id string, state AccessibilityChecked) {
    ...
    if id == "groups" || id == "workstations" { workstations = checked }
    if id == "groups" || id == "servers" { servers = checked }
    Rebuild()
  }
  private func GroupState() AccessibilityChecked -> workstations == servers ? (workstations ? AccessibilityChecked.True : AccessibilityChecked.False) : AccessibilityChecked.Mixed
  public override func Build() Blob -> Container {Width: 660, FlexDirection: FlexDirection.Row, Gap: 24, Children: {
    Container{Width: 300, Gap: 12, Children: {
      ...
      Cell.Mount[TreeViewInput, TreeView]("simple", TreeViewInput{Height: 245, SelectedId: selected, ExpandedIds: expanded, OnExpandedChange: Expand, OnSelect: Select,
        ...
        }}, TreeNode{Id: "media", Label: "Media", Children: []TreeNode{TreeNode{Id: "photos", Label: "Photos"}}}},
      }),
    }},
    Container{Width: 330, Gap: 12, Children: {
      ...
      Cell.Mount[TreeViewInput, TreeView]("checks", TreeViewInput{Height: 245, ExpandedIds: expanded, OnExpandedChange: Expand, MultiSelectable: true,
        ...
        Nodes: []TreeNode{TreeNode{Id: "groups", Label: "All hosts", CheckState: GroupState(), Children: []TreeNode{
          ...
          TreeNode{Id: "servers", Label: "Servers", CheckState: servers ? AccessibilityChecked.True : AccessibilityChecked.False},
          TreeNode{Id: "offline", Label: "Offline hosts", CheckState: AccessibilityChecked.Mixed, Disabled: true},
        }}},
      }),
    }},
  }}
