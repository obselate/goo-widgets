        ...
        return Container{
            ...
            Cell.Mount[TimeAxisInput, TimeAxis](
                ...
                TimeAxisInput{
                    ...
                    PixelsPerHour: 100,
                    MaximumLanes: 2,
                    CurrentTime: start.AddHours(2.75),
                    SelectedId: selected ?? "",
                    OnSelect: (id string) -> {
                        selected = id
                        Rebuild()
                    ...
                    Events: []TimeAxisEvent{
                        ...
                        TimeAxisEvent{
                            ...
                            End: start.AddHours(3.5)
                        },
                        TimeAxisEvent{
                            Id: "release",
                            Label: "Release window",
                            Start: start.AddHours(3.5),
                            End: start.AddHours(5.5)
                        },
                    },
                }
            ),
            Text{
                Key: "state",
                Content: overflow ? "Collapsed event: Diagnostics · 09:00–09:30": selected == nil ? "Select an event or inspect the overlapping entry.": "Selected: " +
                    selected,
                Color: "#a1a1aa",
                FontSize: 13
            }
