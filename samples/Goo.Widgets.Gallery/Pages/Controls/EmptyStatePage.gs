...
class EmptyStatePage : GalleryPage {
  ...
  public override func Build() Blob {
    ...
    let emptyAct = Container{
      ...
      BorderRadius: 6.0, BackgroundColor: Color.Parse("#fafafa"),
    ...
    let emptyCollection = EmptyState{
      ...
      PaddingHorizontal: 20.0, PaddingVertical: 18.0, Gap: 10.0, TextGap: 4.0,
      TitleFontSize: 16.0, DescriptionFontSize: 12.0,
    }
    ...
    let noResAct = Container{
      ...
      BorderRadius: 6.0, BackgroundColor: Color.Parse("#18181b"),
    ...
    let permAct = Container{
      PaddingLeft: 10.0, PaddingRight: 10.0, PaddingTop: 4.0, PaddingBottom: 4.0,
      BorderRadius: 6.0, BackgroundColor: Color.Parse("#450a0a"),
      BorderWidth: 1.0, BorderColor: Color.Parse("#991b1b"),
    ...
    let permission = EmptyState{
      ...
      Width: 360.0, MinHeight: 170.0,
      PaddingHorizontal: 20.0, PaddingVertical: 18.0, Gap: 10.0, TextGap: 4.0,
      TitleFontSize: 16.0, TitleColor: Color.Parse("#fecaca"),
      DescriptionFontSize: 12.0, DescriptionColor: Color.Parse("#fca5a5"),
      BackgroundColor: Color.Parse("#450a0a"), BorderColor: Color.Parse("#991b1b"),
      BorderWidth: 1.0, BorderRadius: 10.0,
    }

    let minimalState = EmptyState{
      AccessibilityName: "All caught up inbox notification", HeadingLevel: 3,
      Title: "You are all caught up",
      Width: 360.0, MinHeight: 170.0,
      PaddingHorizontal: 20.0, PaddingVertical: 18.0,
      TitleFontSize: 15.0, TitleColor: Color.Parse("#d4d4d8"),
      BackgroundColor: Color.Parse("#18181b"), BorderColor: Color.Parse("#3f3f46"),
      BorderWidth: 1.0, BorderRadius: 10.0,
    }

    return Container{
      FlexDirection: FlexDirection.Column,
      AlignItems: AlignItems.Center, JustifyContent: JustifyContent.Center, Gap: 16.0,
      Children: {
        Container{
          ...
          Children: {
            Container{
              FlexDirection: FlexDirection.Column, Gap: 6.0,
              Children: {
