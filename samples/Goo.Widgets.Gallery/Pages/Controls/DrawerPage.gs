...
class DrawerPage : GalleryPage {
  ...
  public override func Build() Blob {
    ...
    let openLeftDrawer = Drawer{
      Open: true, Width: 150.0, Content: leftNavContent, AccessibilityName: "Open left navigation drawer",
    }
    ...
    let openRightDrawer = Drawer{
      Open: true, FromRight: true, Width: 150.0, Content: rightDetailContent, AccessibilityName: "Open right inspector drawer",
    }

    let closedDrawer = Drawer{
      Open: false, Width: 150.0, AccessibilityName: "Closed drawer off-canvas",
    }
    ...
    let customDrawer = Drawer{
      Open: true, FromRight: true, Width: 170.0,
      BackgroundColor: Color.Parse("#052e16"), BorderColor: Color.Parse("#166534"),
      BorderWidth: 1.5, BorderRadius: 10.0, PaddingHorizontal: 14.0, PaddingVertical: 14.0,
      OpenOpacity: 0.95, TransitionMs: 200.0, TransitionEasing: Easing.EaseInOut,
      ...
      Content: customContent, AccessibilityName: "Custom styled drawer",
    }

    let viewport1 = Container{
      Position: PositionType.Relative, Overflow: Overflow.Hidden,
      Width: 280.0, Height: 135.0, BorderRadius: 8.0, BorderWidth: 1.0,
      BorderColor: Color.Parse("#3f3f46"), BackgroundColor: Color.Parse("#09090b"),
      Children: { openLeftDrawer.Build() },
    }
    ...
    let viewport2 = Container{
      ...
      Width: 280.0, Height: 135.0, BorderRadius: 8.0, BorderWidth: 1.0,
      BorderColor: Color.Parse("#3f3f46"), BackgroundColor: Color.Parse("#09090b"),
      Children: { openRightDrawer.Build() },
    }
    ...
    let viewport4 = Container{
      ...
      Width: 280.0, Height: 135.0, BorderRadius: 8.0, BorderWidth: 1.0,
      BorderColor: Color.Parse("#3f3f46"), BackgroundColor: Color.Parse("#09090b"),
      Children: { customDrawer.Build() },
    }

    return Container{
      Width: 580.0, FlexDirection: FlexDirection.Column, Gap: 16.0,
      Children: {
        Container{
          Width: Length.Percent(100.0), FlexDirection: FlexDirection.Row, JustifyContent: JustifyContent.SpaceBetween,
          Children: {
            Container{
              FlexDirection: FlexDirection.Column, Gap: 4.0,
              Children: {
