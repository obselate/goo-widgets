...
class DismissibleContextBarPage : GalleryPage {
  ...
  public override func Build() Blob {
    ...
    let customActionContent = Text{ Content: "Filters applied ∶ Status = Active, Priority = High", FontSize: 13.0, FontWeight: 600 }
    ...
    let disabledContent = Text{ Content: "Applying batch operation (cannot dismiss)", FontSize: 13.0, FontWeight: 600 }
    ...
    let customStyleContent = Text{ Content: "Production workspace connected ∶ 12 nodes online", FontSize: 13.0, FontWeight: 700 }
