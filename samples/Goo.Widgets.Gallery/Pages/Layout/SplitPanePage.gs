...
internal class SplitPaneExample : Cell {
  ...
  public override func Build() Blob -> Container {Width: 600, Gap: 16, Children: {
    ...
    Cell.Mount[SplitPaneInput, SplitPane]("horizontal", SplitPaneInput{
      Value: horizontal, OnChange: (value float64) -> { horizontal = value }, Height: 180, MinimumFirst: 110, MinimumSecond: 160,
    ...
    Cell.Mount[SplitPaneInput, SplitPane]("vertical", SplitPaneInput{
      Value: vertical, OnChange: (value float64) -> { vertical = value }, Height: 180, MinimumFirst: 60, MinimumSecond: 50, Orientation: SplitOrientation.Vertical,
