  ...
  public override func Build() Blob -> Container {
    ...
    Children: {
      Container{
        ...
        Gap: 8.0,
        Children: {
          ActionButton{Label: "Toggle layout", OnClick: () -> { narrow = !narrow }}.Build(),
          ActionButton{Label: "Select item", OnClick: () -> { selected = true }}.Build(),
        },
      },
      MasterDetail{
        Narrow: narrow,
        ...
        Master: Container{
          Padding: 16.0,
          Children: {Text{Content: "Master list", Color: "#fafafa"}},
        },
        Detail: Container{
          Padding: 16.0,
          Children: {Text{Content: "Selected item details", Color: "#fafafa"}},
        },
      }.Build(),
    },
  }
