        ...
        Cell.Mount[TabBarInput, TabBar](
            ...
            TabBarInput{
                ...
                Items: []NavigationItem{
                    NavigationItem{Id: "overview", Label: "Overview"},
                    NavigationItem{Id: "activity", Label: "Activity"},
                    NavigationItem{Id: "locked", Label: "Unavailable", Disabled: true},
                    NavigationItem{Id: "files", Label: "Documents"},
                    NavigationItem{Id: "settings", Label: "Preferences"},
                    NavigationItem{Id: "connections", Label: "Connections"},
                },
            }
        ),
        Container{
