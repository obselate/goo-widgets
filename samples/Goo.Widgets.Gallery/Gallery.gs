  ...
  func IndexOf(title string) int32 {
    ...
    for group in Groups {
      for page in group.Pages {
        if page.Title() == title { return index }
        index++
      }
    }
      ...
      Container{
        ...
        Children: {
          Container{
            ...
            Children: {
              Text{
                Content: "Goo Widgets Gallery",
                FontSize: 26,
                FontWeight: 700,
                Color: "#fafafa",
              },
              Text{
                Content: Registry.CurrentCategory(currentIndex),
                FontSize: 13,
                Color: "#a1a1aa",
              },
            },
          ...
          Text{
            Content: Registry.CurrentPage(currentIndex).Title(),
            FontSize: 16,
            Color: "#d4d4d8",
          },
        },
...
GalleryRegistry([]GalleryCategory{
  ...
  GalleryCategory("Inputs", []GalleryPage{
    ...
    StepperPage{},
    UploadTilePage{},
    SearchListPage{}, ComboBoxPage{}, CalendarPage{}, DatePickerPage{},
    SliderPage{},
  }),
  ...
  GalleryCategory("Layout", []GalleryPage{
    AppBarPage{},
    DrawerPage{},
    SectionHeaderPage{},
    ListRowPage{},
