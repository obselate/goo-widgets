...
public data struct SearchList {
  ...
  public func Build() Blob {
    ...
    var entry = TextEntry{
      ...
      Value: query, Placeholder: Placeholder ?? "Search", OnChange: OnQueryChange,
    ...
    let root = Container{
      ...
      FlexShrink: 0, BackgroundColor: background, BorderWidth: 1,
      BorderColor: selection, BorderRadius: 4, Overflow: Overflow.Hidden,
      Children: {entry},
    }
    if filtered.Count == 0 {
