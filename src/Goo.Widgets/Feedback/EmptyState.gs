...
public data struct EmptyState {
  ...
  public func Build() Blob {
    ...
    let resolved = this with{
      ...
      Opacity = Opacity ?? 1.0,
      TitleFontSize = if TitleFontSize == 0.0 { 20.0 } else { TitleFontSize },
      TitleFontWeight = if TitleFontWeight == 0 { 700 } else { TitleFontWeight },
      DescriptionFontSize = if DescriptionFontSize == 0.0 { 14.0 } else { DescriptionFontSize },
      DescriptionFontWeight = if DescriptionFontWeight == 0 { 400 } else { DescriptionFontWeight },
    ...
    if let createTitle = createTitle {
      ...
      title = Text{Content: resolved.Title!!, Color: resolved.TitleColor!!, FontSize: resolved.TitleFontSize, FontWeight: resolved.TitleFontWeight, Accessibility: Accessibility{Role: AccessibilityRole.Heading, Name: resolved.Title!!, Level: resolved.HeadingLevel}}
    ...
    if resolved.Description != nil {
      if let createDescription = createDescription {
        ...
        description = Text{Content: resolved.Description!!, Color: resolved.DescriptionColor!!, FontSize: resolved.DescriptionFontSize, FontWeight: resolved.DescriptionFontWeight}
        if resolved.FontFamily != nil { description!!.FontFamily = resolved.FontFamily!! }
      }
    }
