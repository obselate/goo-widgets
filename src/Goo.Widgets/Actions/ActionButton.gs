...
public data struct ActionButton {
  ...
  public func Build() Blob {
    ...
    let resolved = this with{
      ...
      Height = if Height == 0.0 { 36.0 } else { Height },
      MinWidth = if MinWidth == 0.0 { 88.0 } else { MinWidth },
      PaddingHorizontal = if PaddingHorizontal == 0.0 { 16.0 } else { PaddingHorizontal },
