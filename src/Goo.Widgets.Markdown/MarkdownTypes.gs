...
public enum MarkdownBlockKind { Paragraph; Heading; Code; Quote; List; ListItem; Rule; Table; TableRow; TableCell; Alert }
/// Distinguishes ordinary styled text and atomic inline content.
public enum MarkdownInlineKind { Text; Code; Link; Image }
